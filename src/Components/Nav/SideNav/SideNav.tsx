...
const SideNav = ({
  ...
  return (
    <aside
      className={`fixed lg:relative top-0 min-h-screen left-0 z-40 transition-all duration-300 ease-in-out ${
        isMobileOpen ? 'translate-x-0' : '-translate-x-full'
      } lg:translate-x-0
      ${isCollapsed ? 'w-28' : 'w-[18rem]'} bg-primary flex flex-col lg:relative`}
    >
